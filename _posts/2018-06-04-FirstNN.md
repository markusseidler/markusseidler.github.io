...
Are you curious now whether the neural network can learn the pattern of the XOR problem?
Do you think it will learn the pattern of this non-linear problem? Or fail?
