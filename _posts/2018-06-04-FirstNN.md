...
This is just the four XOR observations in matrix form. After that I create a class
instance by saying that "ANN" is a class object of ThreeLayerNet. With that I have
access to all the functions I wrote in ann.py.

The next step i to train the neural network and print the actual and estimated
output.

<img src="{{ site.url }}{{ site.baseurl }}/images/FIRSTNN/output.PNG"
alt="Output of ThreeLayerNet">

Not bad. The computer learned in 1000 epoch and in 0.05 secondsthe pattern of
the XOR problem. It took me longer than this.
