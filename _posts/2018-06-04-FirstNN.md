...
This is the formula for the function and it looks like a S. Therefore, the name
sigmoid which is derived from the Greek letter "s". The derivative of the
sigmoid function can be written in two ways and both have the same results.
The difference is just whether the x is the input or the sigmoid function.
