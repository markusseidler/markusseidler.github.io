...
"Cherry" (17). However, the algorithm failed at fruit 14. It cannot classifies
"Banana Red".
...
The cherry image sample have a very distinguish form and a unique color
...
The ultimate test is taking a picture of a banana and let the traind and
test algorithm decide which fruit it is. Here we go, here is a picture
of a banana.
