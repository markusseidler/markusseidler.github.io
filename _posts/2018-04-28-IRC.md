...
date: 2018-05-05
tags: [machine learning, random forest, image recognition]
header:
...
Of course, we could also visualize colors as bars in a 3d diagram and
the length of each bar is a stacked with a section of blue, green, and
red. I was so fascinated by this thought that I started programming. I
carved out each color array, put it on top of each other and placed the
final bars in a 3d space with x and y axis indicating the location of that
particular color point. It took me a while to create this code. I expanded
the image array class by adding new variables and more methods.
...
talking about a three-dimensional view. Would not it be great if can let it
